...
public class PreAuthKey {
    ...
    public static String generateRandomPreAuthKey() throws AuthenticationException {
        try {
            ...
            throw new AuthenticationException("unable to initialize SecureRandom"+ e.getMessage());
        }
    }
